...
import { EmpCallRequestAcc2 } from 'src/assets/data/TableData';
  ...
  return (
    <TableContainer sx={{ marginBottom: '30px',marginTop:'30px' }}>
      ...
      <Table>
        <TableHead>
          <StyledTableRow>
            {EmpCallRequestAcc2.columns.map((column, index) => (
        ...
        <TableBody>
          {EmpCallRequestAcc2.rows.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((row, rowIndex) => (
      ...
      <TablePagination
        ...
        component="div"
        count={EmpCallRequestAcc2.rows.length}
