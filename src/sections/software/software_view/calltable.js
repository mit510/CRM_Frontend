...
import { NetworkViewTableData1 } from 'src/assets/data/TableData';
...
const Calls = () => {
  ...
  return (
    ...
    <Typography variant="h5" align="center" sx={{ marginBottom: '30px'}}>Your Calls </Typography>
      <Table>
        <TableHead>
          <StyledTableRow>
            {NetworkViewTableData1.columns.map((column, index) => (
        ...
        <TableBody>
          {NetworkViewTableData1.rows.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((row, rowIndex) => (
      ...
      <TablePagination
        ...
        component="div"
        count={NetworkViewTableData1.rows.length}
