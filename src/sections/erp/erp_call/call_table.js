...
import { EmpCallRequestAcc1 } from 'src/assets/data/TableData';
  ...
  return (
    ...
    <Typography variant="h5" align="center" sx={{ marginBottom: '30px'}}>Pending / Work In Progress Call</Typography>
      <Table>
        <TableHead>
          <StyledTableRow>
            {EmpCallRequestAcc1.columns.map((column, index) => (
        ...
        <TableBody>
          {EmpCallRequestAcc1.rows.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((row, rowIndex) => (
      ...
      <TablePagination
        ...
        component="div"
        count={EmpCallRequestAcc1.rows.length}
